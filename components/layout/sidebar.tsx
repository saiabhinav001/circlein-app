      ...
      >
        ...
        <nav 
          className={cn(
            ...
            isCollapsed 
              ? "flex flex-col items-center justify-center py-2 px-2 gap-1.5 overflow-y-auto [&::-webkit-scrollbar]:hidden" 
        ...
        <div 
          className={cn(
            ...
            isCollapsed ? "flex flex-col items-center justify-center py-2 px-2 gap-1.5" : "p-3 sm:p-4 space-y-1.5 sm:space-y-2"
          )}
          onMouseMove={(e) => isCollapsed && mouseY.set(e.pageY)}
          onMouseLeave={() => isCollapsed && mouseY.set(Infinity)}
        >
